...
int main(int argc, char **argv){
	...
	flag_home		= "rosrun mavros mavwp load ~/flag_gate_"+course_type+".waypoints";
	flag_emergency	= "rosrun mavros mavwp load ~/emergency_"+course_type+".waypoints";
	...
	while (ros::ok()) {
		...
		while (drone_status=="flag_capture"){

...
(cl:defmethod cl:initialize-instance :after ((m <flight_mode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'flight_mode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboboat-msg:<flight_mode> is deprecated: use roboboat-msg:flight_mode instead.")))

(cl:ensure-generic-function 'flight_mode-val :lambda-list '(m))
(cl:defmethod flight_mode-val ((m <flight_mode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:flight_mode-val is deprecated.  Use roboboat-msg:flight_mode instead.")
  (flight_mode m))

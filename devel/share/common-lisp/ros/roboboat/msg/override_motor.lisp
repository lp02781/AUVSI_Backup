...
(cl:defmethod cl:initialize-instance :after ((m <override_motor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'override_motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboboat-msg:<override_motor> is deprecated: use roboboat-msg:override_motor instead.")))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <override_motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:steering-val is deprecated.  Use roboboat-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <override_motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:throttle-val is deprecated.  Use roboboat-msg:throttle instead.")
  (throttle m))

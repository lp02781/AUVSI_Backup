...
(cl:defmethod cl:initialize-instance :after ((m <node_master>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_master)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roboboat-msg:<node_master> is deprecated: use roboboat-msg:node_master instead.")))
...
(cl:defmethod pid_status-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:pid_status-val is deprecated.  Use roboboat-msg:pid_status instead.")
  (pid_status m))

(cl:ensure-generic-function 'simple_manuver-val :lambda-list '(m))
(cl:defmethod simple_manuver-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:simple_manuver-val is deprecated.  Use roboboat-msg:simple_manuver instead.")
  (simple_manuver m))

(cl:ensure-generic-function 'simple_speed-val :lambda-list '(m))
(cl:defmethod simple_speed-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:simple_speed-val is deprecated.  Use roboboat-msg:simple_speed instead.")
  (simple_speed m))

(cl:ensure-generic-function 'record_manuver-val :lambda-list '(m))
(cl:defmethod record_manuver-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:record_manuver-val is deprecated.  Use roboboat-msg:record_manuver instead.")
  (record_manuver m))

(cl:ensure-generic-function 'record_speed-val :lambda-list '(m))
(cl:defmethod record_speed-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:record_speed-val is deprecated.  Use roboboat-msg:record_speed instead.")
  (record_speed m))

(cl:ensure-generic-function 'path_manuver-val :lambda-list '(m))
(cl:defmethod path_manuver-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:path_manuver-val is deprecated.  Use roboboat-msg:path_manuver instead.")
  (path_manuver m))

(cl:ensure-generic-function 'path_speed-val :lambda-list '(m))
(cl:defmethod path_speed-val ((m <node_master>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roboboat-msg:path_speed-val is deprecated.  Use roboboat-msg:path_speed instead.")
  (path_speed m))
